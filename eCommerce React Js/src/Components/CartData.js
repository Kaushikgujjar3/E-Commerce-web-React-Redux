                                        ...
                                        return (
                                            <>
                                                <tr key={index}>
                                                    ...
                                                    <td align="center">
                                                        <button className="qty-btn" onClick={() => decrementProduct(index)}>-</button>
                                                        {item.qty}
                                                        <button className="qty-btn" onClick={() => incrementProduct(index)}>+</button>
                                                    </td>
                                                    <td>
                                                        <span>
                                                            ₹{item.totalprice}
                                                    ...
                                                    <td align='center'>
                                                        <button onClick={() => removeProduct(item)} className="remove-btn">
                                                            <svg viewBox="0 0 15 17.5" height="17.5" width="15" xmlns="http://www.w3.org/2000/svg" class="btn-icon">
