...
export const slice = createSlice({
    ...
    reducers: {
        ...
        incrementQty: (state, action) => {
            ...
            // Total Price
            state.data[action.payload].totalprice = state.data[action.payload].qty * state.data[action.payload].price;

            // Grand Price
            state.grandPrice += state.data[action.payload].price;
        ...
        decrementQty: (state, action) => {
            ...
            if (state.data[action.payload].totalprice > state.data[action.payload].price) {
                ...
                // Total Price
                state.data[action.payload].totalprice -= state.data[action.payload].price;
